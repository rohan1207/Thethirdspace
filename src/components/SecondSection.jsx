  ...
  const features = [
    {
      ...
      subtitle: "Architectural responses shaped by landscape, light, and local fabric",
    },
    {
      Icon: Mountain,
      title: "Elevated Perspectives",
      subtitle: "Compositions that frame long views and intimate courtyards alike",
    },
    {
      Icon: Leaf,
      title: "Sustainable Practice",
      subtitle: "Material and energy strategies that quietly reduce the footprint",
    },
    {
      Icon: Waves,
      title: "Calm Environments",
      subtitle: "Spaces that balance structure, softness, and everyday comfort",
    },
  ];
        ...
        <div className="w-full lg:w-1/2 lg:pl-16 order-1 lg:order-2 text-left px-0 sm:px-0">
          ...
          >
            ...
            <p className="text-[#6B6B6B] text-sm sm:text-base leading-relaxed mb-6 sm:mb-8 font-light">
              NirlovyaArchitecture Studio crafts quiet, considered spaces where material, light, and proportion work together. From homes to hospitality, every project is tailored to its context and the people who live with it every day.
            </p>
            ...
            <div className="flex flex-row flex-wrap items-center gap-3 sm:gap-6 lg:gap-10">
              ...
              <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                ...
                <span className="text-[#1a1a1a] font-light text-xs sm:text-base leading-tight">
                  Discuss Your <span className="text-[#A0826D]">Project Vision</span>
                </span>
              </div>
            </div>
          </motion.div>
